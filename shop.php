										...
										<li>
											<div class="edit-seting" title="Edit Profile image"><i class="fa fa-sliders"></i>
												<ul class="more-dropdown">
													<li><a href="setting.php" title="">Update Profile Photo</a></li>
													<li><a href="setting.php" title="">Update Header Photo</a></li>
													<li><a href="setting.php" title="">Account Settings</a></li>
													<li><a href="support-and-help.php" title="">Find Support</a></li>
									...
									<div class="row">
										<div class="col-lg-2 col-md-3">
											<div class="profile-author">
												...
												<div class="author-content">
													<a class="h4 author-name" href="about.php">Mega Mart</a>
										...
										<div class="col-lg-10 col-md-9">
											<ul class="profile-menu">
												...
												<li>
													<a class="" href="shop2.php">Market Place</a>
												</li>
												<li>
													<a class="" href="shop-cart.php">Cart</a>
												</li>
												<li>
													<a class="" href="shop-checkout.php">Checkout</a>
												</li>
												<li>
													<a class="" href="shop-detail.php">Prod Detail</a>
												</li>
												<li>
													<div class="more">
														...
														<ul class="more-dropdown">
															<li>
																<a href="timeline-friends2.php">Followers</a>
															</li>
															<li>
																<a href="timeline-photos.php">Photos</a>
															</li>
														</ul>
													</div>
												</li>

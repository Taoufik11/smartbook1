				...
				<div class="row merged20">
					<div class="col-lg-9">
						<div class="forum-warper">
							...
							<a class="addnewforum" href="forum-create-topic.php" title=""><i class="fa fa-plus"></i> Add New</a>
						</div>
						<div class="central-meta">
									...
									<tbody>
										<tr>
											<td>
												...
												<a href="forums-category.php" title="">Asset for creating a beautiful website</a>
										...
										<tr>
											<td>
												<i class="fa fa-comments"></i>
												<a href="forums-category.php" title="">Modifications & Useful Snippets</a>
										...
										<tr>
											<td>
												<i class="fa fa-comments"></i>
												<a href="forums-category.php" title="">Pricing & Redunds</a>
										...
										<tr>
											<td>
												<i class="fa fa-comments"></i>
												<a href="forums-category.php" title="">SEO Optimization</a>
										...
										<tr>
											<td>
												<i class="fa fa-comments"></i>
												<a href="forums-category.php" title="">Server Related Errors and Fixes</a>
										...
										<tr>
											<td>
												<i class="fa fa-comments"></i>
												<a href="forums-category.php" title="">Why should you purchase the winku Template?</a>
										...
										<tr>
											<td>
												<i class="fa fa-comments"></i>
												<a href="forums-category.php" title="">Beginner Guides & Tips</a>

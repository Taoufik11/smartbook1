...
<div class="theme-layout">
	...
	<section>
		<div class="page-header">
			<div class="header-inner">
				<h2>Badges</h2>
				<p>
					Welcome to Smart Social Network. Here you’ll find all the typography, content sources, & ready made elemets as you want. you can use to show on your custom pages.
				</p>
			</div>
						...
						<div class="row remove-ext">
							<div class="col-lg-12">
								<ul class="badge-caro">
									<li>
										...
										<span>Part of smartbook almost 1 years</span>
									</li>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="badge-box">
									...
									<h5>Community & social clinic</h5>
									<p>Has participated in Smart's Community Health research.</p>
									<div class="progress" style="height:10px">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="badge-box">
									...
									<h5>50+ refferal</h5>
									<p>Reffer Smart link and unlock the badge</p>
									<div class="progress" style="height:10px">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="badge-box">
									...
									<h5>$1000+ Earning in Store</h5>
									<p>Earn five hundred dollors via Smart stores products..</p>
									<div class="progress" style="height:10px">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="badge-box">
									...
									<h5>Contributor</h5>
									<p>Become contributor for Smart and social network.</p>
									<div class="progress" style="height:10px">
									  <div class="progress-bar" style="width:60%">60%</div>
									</div>
								</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="badge-box">
									...
									<h5>Shirt Winner</h5>
									<p>Win the competations of Smart socials and get a shirt gift.</p>
									<div class="progress" style="height:10px">
									  <div class="progress-bar" style="width:45%">45%</div>
									</div>
								</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="badge-box">
									...
									<p>You have tranding posts continuously from the Smart.</p>
									<div class="progress" style="height:10px">
	...
	<div class="bottombar">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<span class="copyright">© Smart 2020. All rights reserved.</span>

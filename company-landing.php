...
<div class="theme-layout">
		...
		<nav id="menu" class="res-menu">
			<ul>
				<li><span>Home Pages</span> 
					<ul>
						<li><a href="index.html" title="">Smart Default</a></li>
			...
			<div class="text-caro">
				<div class="unit-text-caro">
					...
					<div class="text-caro-meta">
						<span>Smart Social Network</span>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="welcome-area">
							<h2>Welcome to Smart. MultiPurpose Social Template.</h2>
							<p>
	...
	<footer class="style2 dark">
		...
		<div class="copyright-content">
			<span class="">Copyright © 2020 Smart. All Rights Reserved.</span>

			...
			<ul class="setting-area">
						...
						<div data-gutter="10" class="row">
							<div class="col-md-3">
							  <ul class="dropdown-meganav-select-list-lang">
								...
								<li>
									<a href="#">
									  <img title="Image Title" alt="Image Alternative text" src="images/flags/ARB.png">عربى(Arabic)
									</a>
								  </li>
								<li>
								  <a href="#">
									<img title="Image Title" alt="Image Alternative text" src="images/flags/DE.png">Deutsch (German)
								  </a>
								</li>
								<li>
								  <a href="#">
				...
				<li><a href="#" title="Help" data-ripple=""><i class="fa fa-question-circle"></i></a>
					<div class="dropdowns helps">
						...
						<ul class="help-drop">
							<li><a href="forum.php" title=""><i class="fa fa-book"></i>Community & Social clinic</a></li>
			...
			<ul class="nav-list">
				<li><a class="" href="#" title=""><i class="fa fa-home"></i> Home Pages</a>
					<ul>
						...
						<li><a href="soundnik.php" title="">Smart Sound</a></li>

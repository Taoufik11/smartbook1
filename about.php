...
<?php
include "phpinclude\loadpage.php";
?>
<div class="theme-layout">
  ...
  include 'phpinclude\header.php';
   ...
   <?php
   include 'phpinclude\chatlive.php';
    ?>

    <?php
    include 'phpinclude\siderbarleft.php';
     ?>
					...
					<div class="col-lg-12">
						<div class="row merged20" id="page-contents">
									...
									<div class="row">
										<div class="col-lg-2 col-md-3">
											<div class="profile-author">
												...
												<div class="author-content">
													<a class="h4 author-name" href="about.php">Jack Carter</a>
										...
										<div class="col-lg-10 col-md-9">
											<ul class="profile-menu">
												...
												<li>
													<a class="" href="timeline-friends.php">Friends</a>
												</li>
												<li>
													<a class="" href="timeline-photos.php">Photos</a>
												</li>
												<li>
													<a class="" href="timeline-videos.php">Videos</a>
												</li>
												<li>
													<div class="more">
														...
														<ul class="more-dropdown">
															<li>
																<a href="timeline-groups.php">Profile Groups</a>
															</li>
															<li>
																<a href="statistics.php">Profile Analytics</a>
															</li>
														</ul>
													</div>
												</li>
							...
							<div class="col-lg-8 col-md-8">
								...
								<div class="central-meta">
									<span class="create-post">Friend's (320) <a href="timeline-friends2.php" title="">See All</a></span>
									<ul class="frndz-list">
										<li>
								...
								<div class="central-meta">
									<span class="create-post">Photos (580) <a href="timeline-photos.php" title="">See All</a></span>
								...
								<div class="central-meta">
									<span class="create-post">Videos (33) <a href="timeline-videos.php" title="">See All</a></span>

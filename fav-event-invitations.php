										...
										<li>
											<div class="edit-seting" title="Edit Profile image" data-toggle="tooltip"><i class="fa fa-sliders"></i>
												<ul class="more-dropdown">
													...
													<li>
														<a href="setting.php" title="" data-toggle="tooltip">Account Settings</a>
													</li>
													<li>
														<a href="timeline-friends.php" title="" >Invite Friends</a>
													</li>
													<li>
														<a href="support-and-help.php" title="">Find support</a>
													</li>
													<li>
														<a href="setting.php" title="">Block Page</a>
													</li>
												</ul>
											</div>
										</li>
									...
									<div class="row">
										<div class="col-lg-2">
											<div class="profile-author">
												<a class="profile-author-thumb" href="about.php">
										...
										<div class="col-lg-10">
											<ul class="profile-menu">
												<li>
													<a class="" href="fav-page.php">Page Feed</a>
												</li>
												<li>
													<a class="" href="fav-favers.php">Followers</a>
												</li>
												<li>
													<a class="" href="fav-events.php">Events</a>
												</li>
												<li>
													<a class="active" href="fav-event-invitations.php">Invitations</a>
												</li>
												<li>
													<a class="" href="event-calendar.php">Calender</a>
												</li>
												<li>
													<a href="fav-page-create.php" title="Create New Page"><i class="fa fa-plus-circle"></i></a>
												</li>
											</ul>
									...
									<div class="widget">
										...
										<div class="your-page">
											...
											<div class="page-meta">
												...
												<span><i class="ti-comment"></i><a href="insight.php" title="">Messages <em class="bg-blue">9</em></a></span>
												<span><i class="ti-bell"></i><a href="insight.php" title="">Notifications <em class="bg-purple">2</em></a></span>
											</div>
